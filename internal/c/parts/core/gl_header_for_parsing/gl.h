...
//Don't remove below line, will be used by QB64 to know the version of the GL.
//GLEW_VERSION_1_1
...
WINGDIAPI void APIENTRY glTexImage3D(GLenum target, GLint level, GLint internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const GLvoid *data);
WINGDIAPI void APIENTRY glTexSubImage3D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const GLvoid *data);
...
WINGDIAPI void APIENTRY glCompressedTexImage1D(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const GLvoid *data);
WINGDIAPI void APIENTRY glCompressedTexImage2D(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const GLvoid *data);
WINGDIAPI void APIENTRY glCompressedTexImage3D(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const GLvoid *data);
WINGDIAPI void APIENTRY glCompressedTexSubImage1D(GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const GLvoid *data);
WINGDIAPI void APIENTRY glCompressedTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const GLvoid *data);
WINGDIAPI void APIENTRY glCompressedTexSubImage3D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const GLvoid *data);
WINGDIAPI void APIENTRY glGetCompressedTexImage(GLenum target, GLint lod, GLvoid *img);
WINGDIAPI void APIENTRY glLoadTransposeMatrixd(const GLdouble *m);
WINGDIAPI void APIENTRY glLoadTransposeMatrixf(const GLfloat *m);
WINGDIAPI void APIENTRY glMultTransposeMatrixd(const GLdouble *m);
WINGDIAPI void APIENTRY glMultTransposeMatrixf(const GLfloat *m);
WINGDIAPI void APIENTRY glMultiTexCoord1s(GLenum target, GLshort s);
WINGDIAPI void APIENTRY glMultiTexCoord1sv(GLenum target, const GLshort *v);
WINGDIAPI void APIENTRY glMultiTexCoord1i(GLenum target, GLint s);
WINGDIAPI void APIENTRY glMultiTexCoord1iv(GLenum target, const GLint *v);
WINGDIAPI void APIENTRY glMultiTexCoord1f(GLenum target, GLfloat s);
WINGDIAPI void APIENTRY glMultiTexCoord1fv(GLenum target, const GLfloat *v);
WINGDIAPI void APIENTRY glMultiTexCoord1d(GLenum target, GLdouble s);
WINGDIAPI void APIENTRY glMultiTexCoord1dv(GLenum target, const GLdouble *v);
WINGDIAPI void APIENTRY glMultiTexCoord2s(GLenum target, GLshort s, GLshort t);
WINGDIAPI void APIENTRY glMultiTexCoord2sv(GLenum target, GLshort *v);
WINGDIAPI void APIENTRY glMultiTexCoord2i(GLenum target, GLint s, GLint t);
WINGDIAPI void APIENTRY glMultiTexCoord2iv(GLenum target, GLint *v);
WINGDIAPI void APIENTRY glMultiTexCoord2f(GLenum target, GLfloat s, GLfloat t);
WINGDIAPI void APIENTRY glMultiTexCoord2fv(GLenum target, GLfloat *v);
WINGDIAPI void APIENTRY glMultiTexCoord2d(GLenum target, GLdouble s, GLdouble t);
WINGDIAPI void APIENTRY glMultiTexCoord2dv(GLenum target, GLdouble *v);
WINGDIAPI void APIENTRY glMultiTexCoord3s(GLenum target, GLshort s, GLshort t, GLshort r);
WINGDIAPI void APIENTRY glMultiTexCoord3sv(GLenum target, GLshort *v);
WINGDIAPI void APIENTRY glMultiTexCoord3i(GLenum target, GLint s, GLint t, GLint r);
WINGDIAPI void APIENTRY glMultiTexCoord3iv(GLenum target, GLint *v);
WINGDIAPI void APIENTRY glMultiTexCoord3f(GLenum target, GLfloat s, GLfloat t, GLfloat r);
WINGDIAPI void APIENTRY glMultiTexCoord3fv(GLenum target, GLfloat *v);
WINGDIAPI void APIENTRY glMultiTexCoord3d(GLenum target, GLdouble s, GLdouble t, GLdouble r);
WINGDIAPI void APIENTRY glMultiTexCoord3dv(GLenum target, GLdouble *v);
WINGDIAPI void APIENTRY glMultiTexCoord4s(GLenum target, GLshort s, GLshort t, GLshort r, GLshort q);
WINGDIAPI void APIENTRY glMultiTexCoord4sv(GLenum target, GLshort *v);
WINGDIAPI void APIENTRY glMultiTexCoord4i(GLenum target, GLint s, GLint t, GLint r, GLint q);
WINGDIAPI void APIENTRY glMultiTexCoord4iv(GLenum target, GLint *v);
WINGDIAPI void APIENTRY glMultiTexCoord4f(GLenum target, GLfloat s, GLfloat t, GLfloat r, GLfloat q);
WINGDIAPI void APIENTRY glMultiTexCoord4fv(GLenum target, GLfloat *v);
WINGDIAPI void APIENTRY glMultiTexCoord4d(GLenum target, GLdouble s, GLdouble t, GLdouble r, GLdouble q);
WINGDIAPI void APIENTRY glMultiTexCoord4dv(GLenum target, GLdouble *v);
WINGDIAPI void APIENTRY glSampleCoverage(GLclampf value, GLboolean invert);
